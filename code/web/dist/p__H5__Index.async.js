  ...
  [7],
  {
    vTnR: function(e, t, a) {
            ...
            return (
              ...
              (e.renderPopover = function(t) {
                ...
                return p['createElement'](
                  d['a'],
                  v({}, o, { prefixCls: i, ref: e.saveTooltip, overlay: e.getOverlay(i) })
                );
              }),
              e
            );
          ...
          return (
            E(a, [
                ...
                value: function(e) {
                  ...
                  return (
                    ...
                    p['createElement'](
                      'div',
                      null,
                      a && p['createElement']('div', { className: ''.concat(e, '-title') }, a),
                      p['createElement']('div', { className: ''.concat(e, '-inner-content') }, n)
                    )
                  );
                },
              },
              {
                key: 'render',
                value: function() {
                  return p['createElement'](m['a'], null, this.renderPopover);
                },
              },
            ]),
            a
      ...
      function U(e, t, a) {
        return (
          (t = A()(t)),
          q()(e, W() ? Reflect.construct(t, a || [], A()(e).constructor) : t.apply(e, a))
        );
      }
      function W() {
        try {
      ...
      var Z = V['a'].confirm,
        G =
          ((L = Object(Q['connect'])(function(e) {
            var t = e.api,
              a = e.loading;
            return { api: t, _loading: a.effects['api/getH5List'] };
          })),
          L(
            (T = (function(e) {
              function t() {
                ...
                return (
                  ...
                  (e.handleTableChange = function(t) {
                    e.setState(
                      {
                        params: R()({}, e.state.params, { page: t.current, page_rows: t.pageSize }),
                      },
                      function() {
                  ...
                  (e.showEditModel = function(t, a, n, r) {
                    e.setState(
                      { visible: !0, data: { id: t, title: a, desc: n, auth_code: r } },
                      function() {}
                    );
                  }),
                      ...
                      onOk: function() {
                        return new Promise(function(e, n) {
                          ...
                          r({ type: 'api/delProject', payload: { project_id: t } }).then(
                            function() {
                              a.setState(
                                { params: R()({}, a.state.params, { page: 1 }) },
                                function() {
                  ...
                  (e.onEditFormFieldChange = function(t) {
                    switch (t.target.name) {
                      case 'title':
                        e.setState({ data: R()({}, e.state.data, { title: t.target.value }) });
                        break;
                      case 'desc':
                        e.setState({ data: R()({}, e.state.data, { desc: t.target.value }) });
                        break;
                      case 'auth_code':
                        e.setState({ data: R()({}, e.state.data, { auth_code: t.target.value }) });
                        break;
                    }
                  }),
                  (e.handleEditOk = function() {
                    e.setState({ confirmLoading: !0 }, function() {
                      Object(Y['a'])('/api/editH5List', e.state.data).then(function(t) {
                        e.setState({ confirmLoading: !1 }),
                          200 === t.code &&
                            e.setState(
                              { visible: !1, params: R()({}, e.state.params, { page: 1 }) },
                              function() {
                                e.fetch(e.state.params);
                              }
                            );
                                ...
                                f.a.createElement(
                                  I['a'],
                                  {
                                    title:
                                      '\u786e\u5b9a\u8981\u5237\u65b0\u9879\u76ee\u6807\u8bc6\u5417\uff1f',
                                    onConfirm: function() {
                                      Object(Y['a'])('/api/refreshProjectCode', { id: a.id }).then(
                                        function(t) {
                            ...
                            render: function(t, a) {
                              return f.a.createElement(
                                ...
                                f.a.createElement(
                                  ...
                                  {
                                    onClick: function() {
                                      e.showEditModel(a.id, a.title, a.desc, a.auth_code);
                                    },
                                  },
                                  '\u7f16\u8f91'
                                ),
                      ...
                      return f.a.createElement(
                        ...
                        f.a.createElement(
                          ...
                          f.a.createElement(
                            s['a'].Item,
                            null,
                            f.a.createElement(X['Link'], { to: '/' }, '\u9996\u9875')
                          ),
                          f.a.createElement(
                            s['a'].Item,
                            null,
                            ...
                            V['a'],
                            {
                              ...
                              onOk: function() {
                                e.setState({ confirmLoading: !0 }, function() {
                                  ...
                                  Object(Y['a'])(t, e.state.data).then(function(t) {
                                    e.setState({ confirmLoading: !1 }),
                                      200 === t.code &&
                                        e.setState(
                                          {
                                            visible: !1,
                                            params: R()({}, e.state.params, { page: 1 }),
                                          },
                                          function() {
                                            e.fetch(e.state.params);
                                          }
                            ...
                            f.a.createElement(
                              ...
                              f.a.createElement(
                                ...
                                f.a.createElement(l['a'].Search, {
                                  ...
                                  onSearch: function(t) {
                                    e.setState(
                                      { params: R()({}, e.state.params, { page: 1, search: t }) },
                                      function() {
                                        e.fetch(e.state.params);
                                      }
                                    );
